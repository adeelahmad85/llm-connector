...
DEFAULT_MODEL = "openai/gpt-oss-120b"#"openai/gpt-oss-safeguard-20b"#"qwen/qwen3-32b" #"meta-llama/llama-guard-4-12b" #"llama-3.3-70b-versatile" #"llama-3.1-8b-instant"
